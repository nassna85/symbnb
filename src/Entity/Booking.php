...
class Booking
{
    ...
    /**
     * ON CREE UNE FONCTION POUR NOTRE CYCLE DE VIE pour la date et le montant
     * APPELE A CHAQUE FOIS QU'ON CREE UNE RESERVATION
     * @ORM\PrePersist
     * @ORM\PreUpdate
     */
    ...
    /**
     * ON CREE UNE FONCTION PUBLIC QUI A UN LIEN AVEC NOTRE FONCTION JUSTE AU DESSUS
     * FONCTION QUI NOUS DONNE LE NOMBRE DE JOUR
     */
    public function getDuration()
    {
        $diff = $this->endDate->diff($this->startDate);
        return $diff->days; // Ici on aura le nombre de jour ecoulé entre les 2 dates !
    }

    /**
     * Permet de savoir si les dates sont bonnes !
     *
     * @return boolean
     */
    public function isBookableDates()
    {
        ...
        //Tableau de chaine de caractères contenant mes journées
